    ...
    <img src="/logo1.png" alt="Visual Health Logo" className="logo" />
      ...
      <AppBar position="fixed" style={{ backgroundColor: '#4E9064' }}>
        <Toolbar className='Toolbar'>
          <Link to="/smoking" className={`${location.pathname === "/smoking" ? "active-link" : ""} navbar-link`}>Smoking and Lung Cancer</Link>
          <Link to="/aerobicexecise" className={`${location.pathname === "/aerobicexecise" ? "active-link" : ""} navbar-link`}>BloodPressure</Link>
          <Link to="/reduceweight" className={`${location.pathname === "/reduceweight" ? "active-link" : ""} navbar-link`}>Intermittent Fasting</Link>
