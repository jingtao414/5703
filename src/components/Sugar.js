  ...
  return (
    ...
    <div className="main-container" >
      ...
      <div className='image-container'>
        ...
        <img id="sugar-img" src='/Sugar/sugar2.png' alt='sugar drink image2' />
        <p>Sugar-Sweetened Beverages (SSB): These are drinks loaded with added sugars, such as regular sodas and sweetened iced teas. They are known for their delicious taste but have concerning health implications.

          Artificially Sweetened Beverages (ASB): ASBs are marketed as healthier alternatives with artificial sweeteners. However, their effects on our health may surprise you.

          Fruit Juices (FJ): Natural and refreshing, fruit juices seem like a healthy choice, but they can pack a sugary punch that's worth exploring.

          Through interactive visualizations and insightful information, we aim to provide you with a clear understanding of how these beverages can impact your health. Whether it's the increased risk of developing type 2 diabetes or other health consequences, our goal is to empower you with knowledge to make informed choices. Let's dive in and discover the real story behind your favorite drinks.
        </p>
      </div>
