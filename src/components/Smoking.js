  ...
  return (
      ...
      <div>
        <div className="sidebar">
          ...
          <div className='image-container-smoking'>
              ...
              <div className="container">
                  ...
                  <div className="image-section">
                      <img src="/smoking/45a.webp" alt="lung cancer" />
                  </div>
              </div>
          </div>

          <div className='image-container-smoking'>
              <h2 id="chart1">Smoker Rate among Lung Cancer and non-Lung Cancer Groups</h2>
              <p>
          ...
          <div className='image-container-smoking'>
            <h2 id="chart2">Lung Cancer Risk among Male and Female smokers</h2>
              <p>
          ...
          <div className='image-container-smoking'>
              <h2 id="chart3">Different Countries situation of Lung Cancer Risk</h2>
              <p>
