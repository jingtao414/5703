...
function Smoking() {
  ...
  return (
    ...
    <div>
      ...
      <div className="tableauPlaceholder" id="viz1696661127439" style={{ position: 'relative' }}>
        <noscript>
          <a href="#">
            <img alt="Smoker Rate among Cancer and Control Group" src="https://public.tableau.com/static/images/Sm/SmokerRate/ofsmokeofcancerandcontrolgroup/1_rss.png" style={{ border: 'none' }} />
          </a>
        </noscript>
        <object className="tableauViz" style={{ display: 'none', width: '1100px', height: '827px' }}>
          ...
          <param name="name" value="Jason_4&#47;ofsmokeofcancerandcontrolgroup" />
          <param name="tabs" value="no" />
          <param name="toolbar" value="yes" />
          <param name="static_image" value="https://public.tableau.com/static/images/Ja/Jason_4/ofsmokeofcancerandcontrolgroup/1.png" />
