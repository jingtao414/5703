  ...
  function SplitImageComponent() {
    return (
      <div className="split-image-container">
        ...
        <div className="text-overlay"><span style={{ color: 'red' }}>High blood pressure </span>silently harms millions. However, <span style={{ color: 'green' }}>regular aerobic exercises </span>offer a powerful shield, effectively lowering blood pressure. Explore how various nations utilize this defense against the silent menace</div>
      </div>
    );
  }
  ...
  return (
    ...
    <div>
      ...
      <div className='image-container'>
        <h2 id="chart1">Blood Pressure Levels in Different Countries Post-Aerobic Exercise</h2>
      ...
      <div className='image-container'>
        <h2 id="chart2">AerobicExercise will reduce blood pressure</h2>
      ...
      <div className='image-container'>
        <h2 id="chart3">Blood Pressure Reduction & Cardiovascular Benefits Across Genders Post-Aerobic Exercise</h2>
        <p>Globally, exercise habits differ among genders. With such variations, a critical insight emerges:
          Do both genders equally benefit from the cardiovascular advantages of lowered blood pressure through aerobic exercise?
          Dive into the data to uncover the link between blood pressure reduction and decreased risk of cardiovascular diseases.</p>
